...
const FAQS = {
  en: [
    ...
    { q: 'How can I hire you?', a: 'Click "Start chat" below or email gabriel.pedreros.dev@gmail.com' },
  ],
  es: [
    ...
    { q: 'Como puedo contratarte?', a: 'Haz clic en "Iniciar chat" o escribe a gabriel.pedreros.dev@gmail.com' },
  ],
};
