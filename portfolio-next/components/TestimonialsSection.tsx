              ...
              <AnimeWrapper key={item.id} delay={100 + i * 100}>
                <div className="card flex flex-col h-full">
                  ...
                  <div className="border-t border-neutral-200 dark:border-neutral-800 pt-4 mt-auto">
                    <p className="text-sm font-semibold text-[#1a1a2e] dark:text-white">{item.author}</p>
                    <p className="text-xs text-neutral-400 dark:text-neutral-500">{item.role[lang]}</p>
                  </div>
                </div>
              </AnimeWrapper>
            ))}
